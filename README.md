# 💫 About Me:
🌟 Always on the lookout for: Challenging coding projects and opportunities to grow as a full-stack developer.<br>🧩 Open to collaboration: On projects that combine creativity, problem-solving, and innovation.<br>🧑‍💻 Currently learning: ASP.NET for full-stack development and exploring scalable database solutions.<br>💡 Ask me about: C#, PostgreSQL, JavaScript, or how to bake the best brownies.<br>🎮 Fun fact: I balance my passion for coding with gaming, crochet, and solving puzzles—Ravenclaw style!
